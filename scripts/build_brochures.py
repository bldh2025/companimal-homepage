...
COUPANG_REVIEW_SNAPSHOT = dict(PRODUCT_REVIEW_SNAPSHOT["coupang"])
COUPANG_REVIEW_AS_OF = str(COUPANG_REVIEW_SNAPSHOT["asOf"])
COUPANG_REVIEW_COUNTS = {
    key: int(value["count"])
    for key, value in dict(COUPANG_REVIEW_SNAPSHOT["products"]).items()
}
COUPANG_REVIEW_TOTAL = int(COUPANG_REVIEW_SNAPSHOT["total"])
COUPANG_REVIEW_DEFINITION = str(COUPANG_REVIEW_SNAPSHOT["definition"])
