(function () {
  ...
  function makeReviewSlide(doc, lineup, snapshot) {
    ...
    heading.appendChild(element(doc, "p", "쿠팡을 포함한 회사 제공 판매채널의 공개 리뷰를 제품군 기준으로 합산해 시장 반응의 규모를 보여드립니다.", "margin:0;font-size:27px;line-height:1.55;font-weight:300;color:#c8d8cd;max-width:1280px;"));
  ...
  window.enhanceCompanyProfile = function (doc) {
    ...
    if (sections.length !== 13 || sections[5] !== lineup || sections[6] !== reviewSlide || sections[7] !== guide) {
